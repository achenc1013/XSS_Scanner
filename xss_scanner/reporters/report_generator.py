            ...
            <tr>
                <td colspan="5">
                    <div class="vuln-details">
                        <p><strong>详情：</strong> {html.escape(vuln.get('details', ''))}</p>
                        <p><strong>Payload：</strong> {html.escape(vuln.get('payload', ''))}</p>
                        <p><strong>修复建议：</strong> {html.escape(vuln.get('recommendation', ''))}</p>
                    </div>
                </td>
            </tr>
"""
